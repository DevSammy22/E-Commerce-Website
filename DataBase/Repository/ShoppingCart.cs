    ...
    public class ShoppingCart
    {
        ...
        public List<ShoppingCartItem> GetShoppingCartItems()
        {
            return ShoppingCartItems ?? (
                ShoppingCartItems = _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartId).Include(c => c.Product).ToList());
        ...
        {
            var total = _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartId == ShoppingCartId).Select(c => c.Product.Price * c.Amount).Sum();
            return total;

            //decimal total = _appDbContext.ShoppingCartItems.Where(c => c.ShoppingCartItemId == ShoppingCartId)
